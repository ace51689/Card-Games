...
oneGuess.addEventListener('click', function () {
    ...
    if (guessArray.includes(cardIndex)) {
        ...
        if (currFtdCard.includes('2')) {
            two = two - 1
            twos.innerText = two
        }
        else if (currFtdCard.includes('3')) {
            three = three - 1
            threes.innerText = three
        }
        else if (currFtdCard.includes('4')) {
            four = four - 1
            fours.innerText = four
        }
        else if (currFtdCard.includes('5')) {
            five = five - 1
            fives.innerText = five
        }
        else if (currFtdCard.includes('6')) {
            six = six - 1
            sixes.innerText = six
        }
        else if (currFtdCard.includes('7')) {
            seven = seven - 1
            sevens.innerText = seven
        }
        else if (currFtdCard.includes('8')) {
            eight = eight - 1
            eights.innerText = eight
        }
        else if (currFtdCard.includes('9')) {
            nine = nine - 1
            nines.innerText = nine
        }
        else if (currFtdCard.includes('10')) {
            ten = ten - 1
            tens.innerText = ten
        }
        else if (currFtdCard.includes('J')) {
            jack = jack - 1
            jacks.innerText = jack
        }
        else if (currFtdCard.includes('Q')) {
            queen = queen - 1
            queens.innerText = queen
        }
        else if (currFtdCard.includes('K')) {
            king = king - 1
            kings.innerText = king
        }
        else if (currFtdCard.includes('A')) {
            ace = ace - 1
            aces.innerText = ace
        }
